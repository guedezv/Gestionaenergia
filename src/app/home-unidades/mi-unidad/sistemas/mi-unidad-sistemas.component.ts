...
@Component({
  selector: 'app-mi-unidad-sistemas',
  standalone: true,
  imports: [CommonModule, RouterLink, HeaderComponent, SidebarComponent, FooterComponent],
  templateUrl: './mi-unidad-sistemas.component.html',
  styleUrls: ['./mi-unidad-sistemas.component.scss']
})
export class MiUnidadSistemasComponent {
